...
alert("webrtc_detialMeeting username"+ username + " ,room:" + room);
//-------------- * *
...
/*
다 대 다 방식
자신이 publisher이면서 subscriber
타인이 publisher이면서 subscriber
publisher : 화면, 오디오 송출 
subscriber : 화면, 오디오 수신
*/
	...
	sfutest.createOffer(
		{
			...
			//meeting방식이기 때문에 수신과 송출 모두 true로 설정
